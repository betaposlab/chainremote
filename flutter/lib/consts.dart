...
// 원격 중 채팅을 펼쳤을 때 — 맥 HQ 채팅창(250x350)과 같은 세로형 독립 창 구성.
// 헤더(32) + 대화 + 입력 + 하단 상태줄(32). 위치는 이제 전환 때 보존되므로 폭을
// 다른 상태와 맞출 필요가 없다. Sciter 쪽(cm.tis applyCmBanner)과 같은 값.
const Size kAgentSupportChatSize = Size(340, 400);
