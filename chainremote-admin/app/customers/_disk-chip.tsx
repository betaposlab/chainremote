...
export function DiskChip({
  ...
  return (
    <span className="inline-flex items-center gap-1">
      ...
      {level !== "ok" &&
        (waiting ? (
          <span className="text-[10px] text-[#a3aac2] whitespace-nowrap">
            정리 중…
          </span>
        ) : (
          <button
            ...
            className="rounded border border-[#6274a3] bg-[#2e3a5c] hover:bg-white/[0.06] px-1.5 py-0.5 text-[10px] text-[#abaebb] disabled:opacity-50 whitespace-nowrap"
