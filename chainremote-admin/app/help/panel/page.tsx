  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 md:px-8">
      ...
      <Section n={4} title="지원기록">
        ...
        <Item name="행 펼치기 (▸)">
          누르면 그 건의 상세가 나옵니다. 담당 직원, 응대자, A/S 종류, 연결 경로,
          <b>접속 기기</b>(그 원격을 어느 PC 에서 했는지 — 컴퓨터 이름과 IP)까지 보입니다.
          <Note>
            같은 계정이라도 사무실 PC · 집 · 빌린 PC(ChainGo) 가 다 다르게 찍힙니다. 낯선
            이름이나 IP 가 보이면 계정이 새는지 의심해 보세요. 다만 컴퓨터 이름은 바꿀 수 있고
            IP 는 공유기 단위라 <b>정황이지 증거는 아닙니다</b>.
          </Note>
        </Item>
