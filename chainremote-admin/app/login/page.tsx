...
export default async function LoginPage({
  ...
  return (
    <div className="aurora-bg flex min-h-screen w-full flex-col items-center justify-center bg-[#14171f] px-4">
      <div className="relative z-10 w-full max-w-sm space-y-6 rounded-xl border border-[#2c3852] bg-[#1e2740] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.5)]">
        ...
        <form action={login} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-[#d6d8de]" htmlFor="username">
              아이디
            </label>
            <input
              id="username"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-[#d6d8de]" htmlFor="password">
              비밀번호
            </label>
            <input
              id="password"
      ...
      <footer className="relative z-10 mt-8 text-center text-xs leading-relaxed text-[#838aa4]">
        <p>
