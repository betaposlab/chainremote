...
export default async function LoginPage({
  ...
  return (
    <div className="aurora-bg flex min-h-screen w-full flex-col items-center justify-center bg-[#1c2333] px-4">
      <div className="relative z-10 w-full max-w-sm space-y-6 rounded-xl border border-[#46557c] bg-[#2e3a5c] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.5)]">
        ...
        <form action={login} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-[#eef0f4]" htmlFor="username">
              아이디
            </label>
            <input
              id="username"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-[#eef0f4]" htmlFor="password">
              비밀번호
            </label>
            <input
              id="password"
      ...
      <footer className="relative z-10 mt-8 text-center text-xs leading-relaxed text-[#a3aac2]">
        <p>
