...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비 완료"),
        ("Established", "연결됨"),
        ("connecting_status", "ChainRemote 네트워크에 연결 중..."),
        ...
        ("Enable keyboard/mouse", "내 PC 키보드·마우스 조작 허용"),
        ("Enable clipboard", "내 PC 와 복사·붙여넣기 공유 허용"),
        ("Enable file transfer", "내 PC 와 파일 전송 허용"),
        ("Enable TCP tunneling", "TCP 터널링 허용 (포트 포워딩)"),
        ...
        ("Audio Input", "본사 마이크"),
        ("Enhancements", "향상된 기능"),
        ("Hardware Codec", "하드웨어 가속"),
        ("Adaptive bitrate", "자동 화질 조절"),
        ("ID Server", "ID 서버"),
        ("Relay Server", "릴레이 서버"),
        ("API Server", "API 서버"),
        ...
        ("Retry", "다시 시도"),
        ("OK", "확인"),
        ("Password Required", "거래처 비밀번호 입력"),
        ("Please enter your password", "거래처 비밀번호를 입력하세요"),
        ("Remember password", "이 거래처 비밀번호 기억하기"),
        ...
        ("Block user input", "거래처 키보드·마우스 잠금"),
        ("Unblock user input", "사용자 입력 차단 해제"),
        ("Adjust Window", "원격 화면 크기 맞춤"),
        ("Original", "원본"),
        ("Shrink", "축소"),
        ("Stretch", "늘이기"),
        ("Scrollbar", "스크롤 막대"),
        ("ScrollAuto", "자동 스크롤"),
        ("Good image quality", "고화질 (또렷)"),
        ("Balanced", "균형 (보통)"),
        ("Optimize reaction time", "빠른 반응 (살짝 흐리지만 끊김 없음)"),
        ("Custom", "사용자 지정"),
        ("Show remote cursor", "거래처 마우스 커서 표시"),
        ("Show quality monitor", "화질·속도 표시기 보기"),
        ("Disable clipboard", "클립보드 사용 안 함"),
        ("Lock after session end", "원격 끝나면 거래처 PC 화면 잠금"),
        ("Insert Ctrl + Alt + Del", "Ctrl + Alt + Del 입력 전송"),
        ("Insert Lock", "거래처 PC 화면 잠금"),
        ("Refresh", "화면 새로 고침"),
        ("ID does not exist", "ID가 존재하지 않습니다"),
        ("Failed to connect to rendezvous server", "랑데부 서버 연결에 실패했습니다"),
        ("Please try later", "나중에 시도해 주세요"),
        ("Remote desktop is offline", "상대 PC 가 꺼져 있거나 인터넷이 끊겼습니다"),
        ...
        ("OS Password", "윈도우 로그인 비번 전송"),
        ("install_tip", "UAC로 인해 경우에 따라 ChainRemote가 원격 쪽에서 제대로 작동하지 않을 수 있습니다. UAC를 피하려면 아래 버튼을 클릭하여 시스템에 ChainRemote를 설치하세요."),
        ("Click to upgrade", "업그레이드"),
        ("Configure", "구성"),
        ("config_acc", "데스크탑을 원격으로 제어하려면 ChainRemote에 \"접근성\" 권한을 부여해야 합니다."),
        ("config_screen", "데스크탑에 원격으로 액세스하려면 ChainRemote에 \"화면 녹화\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("Permissions", "내 PC 에 들어온 사람이 할 수 있는 일"),
        ("Accept", "수락"),
        ("Dismiss", "거부"),
        ("Disconnect", "원격 종료"),
        ...
        ("Closed manually by the peer", "거래처에서 원격을 종료했습니다"),
        ("Enable remote configuration modification", "내 PC 설정 변경 허용"),
        ...
        ("Wrong credentials", "ID 또는 비밀번호가 맞지 않습니다"),
        ...
        ("android_input_permission_tip1", "원격 장치에서 마우스나 터치로 Android 장치를 제어하려면 ChainRemote가 \"접근성\" 서비스를 사용하도록 허용해야 합니다."),
        ("android_input_permission_tip2", "다음 시스템 설정 페이지로 이동하여 [설치된 서비스]를 찾아 들어가서 [ChainRemote 입력] 서비스를 켜세요."),
        ...
        ("Turned off", "꺼짐"),
        ("Language", "화면 언어"),
        ("Keep ChainRemote background service", "ChainRemote 백그라운드 서비스 유지"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시"),
        ("android_open_battery_optimizations_tip", "이 기능을 비활성화하려면 다음 ChainRemote 응용 프로그램 설정 페이지로 이동하여 [배터리]를 찾아서 입력하고 [제한 없음]을 선택 취소하세요"),
        ...
        ("Use permanent password", "영구 비밀번호 사용 (0클릭 무인 접속용)"),
        ("Use both passwords", "두 가지 비밀번호 모두 사용"),
        ("Set permanent password", "영구 비밀번호 설정"),
        ("Enable remote restart", "내 PC 재시작 허용"),
        ("Restart remote device", "거래처 PC 재시작"),
        ...
        ("Scale original", "원본 크기 그대로"),
        ("Scale adaptive", "본사 창 크기에 맞춤"),
        ("General", "일반"),
        ("Security", "고급 보안"),
        ("Theme", "화면 모양"),
        ("Dark Theme", "어두운 테마"),
        ...
        ("Enable hardware codec", "하드웨어 가속 사용 (영상 처리 빠름)"),
        ("Unlock Security Settings", "보안 설정 잠금 해제"),
        ("Enable audio", "내 PC 소리 공유 허용"),
        ("Unlock Network Settings", "네트워크 설정 잠금 해제"),
        ("Server", "서버"),
        ("Direct IP Access", "본사 NAS 안 거치고 IP 로 직접 접속 허용"),
        ("Proxy", "프록시 서버"),
        ("Apply", "적용"),
        ("Disconnect all devices?", "모든 장치의 연결을 해제하시겠습니까?"),
        ("Clear", "지우기"),
        ("Audio Input Device", "본사 마이크 장치"),
        ("Use IP Whitelisting", "특정 본사 IP 만 접속 허용 (화이트리스트)"),
        ("Network", "네트워크"),
        ("Pin Toolbar", "도구 모음 고정"),
        ("Unpin Toolbar", "도구 모음 고정 해제"),
        ("Recording", "세션 자동 녹화"),
        ("Directory", "영상 저장 위치"),
        ("Automatically record incoming sessions", "누가 내 PC 원격할 때 영상 자동 저장"),
        ("Automatically record outgoing sessions", "내가 거래처 원격할 때 영상 자동 저장"),
        ("Change", "변경"),
        ("Start session recording", "세션 녹화 시작"),
        ("Stop session recording", "세션 녹화 중지"),
        ("Enable recording session", "내 PC 화면 녹화 허용"),
        ("Enable LAN discovery", "LAN 검색 허용"),
        ("Deny LAN discovery", "같은 인터넷의 다른 PC 가 나를 못 보게 함"),
        ...
        ("Disconnected", "연결 끊김"),
        ("Other", "일반 동작"),
        ("Confirm before closing multiple tabs", "여러 거래처 창을 한 번에 닫을 때 한 번 더 묻기"),
        ("Keyboard Settings", "키보드 설정"),
        ("Full Access", "모든 권한 허용"),
        ("Screen Share", "화면 보기만 (조작 금지)"),
        ...
        ("Show ChainRemote", "ChainRemote 표시"),
        ("This PC", "이 PC"),
        ("or", "또는"),
        ("Elevate", "권한 상승"),
        ...
        ("Group", "그룹"),
        ("Search", "검색"),
        ("Closed manually by web console", "관리 화면에서 원격을 종료했습니다"),
        ("Local keyboard type", "내 키보드 종류"),
        ...
        ("config_input", "키보드로 원격 데스크탑을 제어하려면 ChainRemote에 \"입력 모니터링\" 권한을 부여해야 합니다."),
        ("config_microphone", "원격으로 통화하려면 ChainRemote에 \"오디오 녹음\" 권한을 부여해야 합니다."),
        ...
        ("still_click_uac_tip", "여전히 원격 사용자가 ChainRemote를 실행하는 UAC 창에서 확인을 클릭해야 합니다."),
        ...
        ("Display", "디스플레이"),
        ("Default View Style", "기본 화면 맞춤 방식"),
        ("Default Scroll Style", "기본 스크롤 방식"),
        ("Default Image Quality", "기본 화질"),
        ("Default Codec", "기본 영상 압축 방식"),
        ("Bitrate", "비트레이트"),
        ("FPS", "FPS"),
        ("Auto", "자동"),
        ("Other Default Options", "원격 세션 동작 옵션"),
        ("Voice call", "거래처와 음성 통화"),
        ("Text chat", "거래처와 채팅"),
        ...
        ("show_monitors_tip", "툴바에 거래처 모니터 번호 표시"),
        ("View Mode", "보기 전용(조작 금지)"),
        ("login_linux_tip", "X 데스크탑을 활성화하려면 제어되는 터미널의 Linux 계정에 로그인하세요"),
        ("verify_rustdesk_password_tip", "거래처 PC 의 ChainRemote 비밀번호"),
        ("remember_account_tip", "이 거래처 계정 기억하기"),
        ...
        ("Disable", "사용 안 함"),
        ("Options", "옵션"),
        ("resolution_original_tip", "거래처 원본 해상도 사용"),
        ("resolution_fit_local_tip", "내 화면 크기에 맞춤"),
        ("resolution_custom_tip", "사용자 지정 해상도"),
        ("Collapse toolbar", "원격 상단 툴바 접기"),
        ...
        ("Sync with recent sessions", "최근 세션 정보 동기화"),
        ("Sort tags", "태그 정렬"),
        ("Open connection in new tab", "거래처 접속 시 새 탭으로 열기"),
        ("Move tab to new window", "이 거래처 새 창으로 분리"),
        ...
        ("scam_text1", "알지 못하고 신뢰할 수 없는 사람이 전화를 걸어 ChainRemote를 사용하고 서비스를 시작하라고 요청하는 경우 계속 진행하지 말고 즉시 전화를 끊으세요."),
        ("scam_text2", "사기꾼이 귀하의 돈이나 기타 개인 정보를 훔치려 할 가능성이 높습니다."),
        ("Don't show again", "다시 표시하지 않음"),
        ("I Agree", "동의"),
        ("Decline", "거절"),
        ("Timeout in minutes", "시간 초과 (분)"),
        ("auto_disconnect_option_tip", "거래처가 자리 비웠을 때(키보드·마우스 안 움직임) 원격 자동 종료"),
        ("Connection failed due to inactivity", "활동이 없어 자동으로 연결이 끊어졌습니다"),
        ("Check for software update on startup", "앱 시작 시 업데이트 확인"),
        ("upgrade_rustdesk_server_pro_to_{}_tip", "ChainRemote Server Pro를 {} 버전 이상으로 업그레이드하세요!"),
        ("pull_group_failed_tip", "그룹 새로 고침에 실패했습니다"),
        ("Filter by intersection", "교차해서 필터링"),
        ("Remove wallpaper during incoming sessions", "원격 받는 동안 배경화면 숨김 (성능 향상)"),
        ("Test", "테스트"),
        ("display_is_plugged_out_msg", "디스플레이가 분리되어 있으면 첫 번째 디스플레이로 전환합니다."),
        ("No displays", "디스플레이 없음"),
        ("Open in new window", "새 창에서 열기"),
        ("Show displays as individual windows", "거래처 모니터마다 별도 창으로 표시"),
        ("Use all my displays for the remote session", "내 모든 모니터를 원격 화면에 사용"),
        ("selinux_tip", "SELinux가 장치에서 활성화되어 있어 ChainRemote가 제어된 상태로 제대로 작동하지 않을 수 있습니다."),
        ("Change view", "보기 변경"),
        ("Big tiles", "큰 타일"),
        ("Small tiles", "작은 타일"),
        ("List", "목록"),
        ("Virtual display", "가상 모니터 추가"),
        ("Plug out all", "모든 플러그를 뽑으세요"),
        ("True color (4:4:4)", "트루컬러 (4:4:4)"),
        ("Enable blocking user input", "원격 중 거래처 키보드·마우스 잠금 허용"),
        ...
        ("Swap control-command key", "Mac Control↔Command 키 교체"),
        ...
        ("allow-only-conn-window-open-tip", "ChainRemote 창이 열려 있을 때만 연결 허용"),
        ("no_need_privacy_mode_no_physical_displays_tip", "실제 디스플레이가 없으므로 개인 정보 보호 모드를 사용할 필요가 없습니다."),
        ("Follow remote cursor", "거래처 커서 따라 화면 이동"),
        ("Follow remote window focus", "거래처가 클릭한 창 따라 보기"),
        ...
        ("floating_window_tip", "ChainRemote 백그라운드 서비스를 유지하는 데 도움이 됩니다"),
        ...
        ("About ChainRemote", "ChainRemote 정보"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ChainRemote 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!"),
        ...
        ("Enable remote printer", "본사 프린터로 인쇄 허용"),
        ("Downloading {}", "{} 다운로드 중"),
        ("{} Update", "{} 업데이트"),
        ...
        ("Show my cursor", "내 마우스 커서 거래처에 표시"),
        ("Scale custom", "사용자 지정 크기"),
        ...
        ("Edit note", "노트 편집"),
        ("Alias", "별명"),
        ("ScrollEdge", "화면 가장자리 스크롤"),
        ("Allow insecure TLS fallback", "보안되지 않은 TLS 폴백 허용"),
        ("allow-insecure-tls-fallback-tip", "기본적으로 ChainRemote는 TLS를 사용하여 프로토콜에 대한 서버 인증서를 검증합니다.\n이 옵션을 활성화하면 ChainRemote는 인증 단계를 건너뛰고 인증 실패 시 진행합니다."),
        ("Disable UDP", "UDP 사용 안 함"),
        ("disable-udp-tip", "TCP만 사용할지 여부를 제어합니다.\n이 옵션을 활성화하면 ChainRemote는 더 이상 UDP 2116을 사용하지 않고 대신 TCP 2116을 사용합니다."),
        ("server-oss-not-support-tip", "참고: ChainRemote 서버 OSS에는 이 기능이 포함되어 있지 않습니다."),
        ("input note here", "여기에 노트 입력"),
        ("note-at-conn-end-tip", "거래처 접속 끝나면 지원 메모 작성 요청"),
        ("Show terminal extra keys", "터미널 추가 키 표시"),
        ("Relative mouse mode", "상대 좌표 마우스 (게임용)"),
        ...
        ("Changelog", "변경 기록"),
        ("keep-awake-during-outgoing-sessions-label", "내가 거래처 원격하는 동안 내 화면 안 꺼짐"),
        ("keep-awake-during-incoming-sessions-label", "내가 원격당하는 동안 내 화면 안 꺼짐"),
