...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable keyboard/mouse", "키보드·마우스 조작 허용"),
        ("Enable clipboard", "복사·붙여넣기 공유 허용"),
        ...
        ("Enable remote configuration modification", "원격 중에 거래처 PC 설정 변경 허용"),
        ...
        ("Enable remote restart", "원격으로 거래처 PC 재시작 허용"),
        ...
        ("Enable recording session", "원격 영상 녹화 허용"),
