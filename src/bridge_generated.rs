...
fn wire_chainremote_logout_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_logout",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(chainremote_logout()),
    )
}
fn wire_chainremote_is_authenticated_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_is_authenticated",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(chainremote_is_authenticated()),
    )
}
fn wire_chainremote_get_user_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_get_user",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(chainremote_get_user()),
    )
}
fn wire_chainremote_get_token_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_get_token",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(chainremote_get_token()),
    )
}
fn wire_chainremote_get_api_base_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_get_api_base",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(chainremote_get_api_base()),
    )
}
fn wire_chainremote_set_api_base_impl(
    url: impl Wire2Api<String> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_set_api_base",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || {
            let api_url = url.wire2api();
            Ok(chainremote_set_api_base(api_url))
        },
    )
}
...
fn wire_chainremote_load_customers_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "chainremote_load_customers",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(chainremote_load_customers()),
    )
}
fn wire_chainremote_load_favorites_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "chainremote_load_favorites",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(chainremote_load_favorites()),
    )
}
...
fn wire_chainremote_is_favorite_impl(
    remote_id: impl Wire2Api<String> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_is_favorite",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || {
            let api_remote_id = remote_id.wire2api();
            Ok(chainremote_is_favorite(api_remote_id))
        },
    )
}
fn wire_chainremote_get_favorite_ids_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "chainremote_get_favorite_ids",
            port: None,
            mode: FfiCallMode::Sync,
        },
