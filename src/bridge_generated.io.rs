...
#[no_mangle]
pub extern "C" fn wire_chainremote_is_authenticated() -> support::WireSyncReturn {
    wire_chainremote_is_authenticated_impl()
}

#[no_mangle]
pub extern "C" fn wire_chainremote_get_user() -> support::WireSyncReturn {
    wire_chainremote_get_user_impl()
}

#[no_mangle]
pub extern "C" fn wire_chainremote_get_token() -> support::WireSyncReturn {
    wire_chainremote_get_token_impl()
}

#[no_mangle]
pub extern "C" fn wire_chainremote_get_api_base() -> support::WireSyncReturn {
    wire_chainremote_get_api_base_impl()
}

#[no_mangle]
pub extern "C" fn wire_chainremote_set_api_base(
    url: *mut wire_uint_8_list,
) -> support::WireSyncReturn {
    wire_chainremote_set_api_base_impl(url)
}
...
#[no_mangle]
pub extern "C" fn wire_chainremote_load_favorites(port_: i64) {
    wire_chainremote_load_favorites_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_chainremote_sched_close(port_: i64, remote_id: *mut wire_uint_8_list) {
    wire_chainremote_sched_close_impl(port_, remote_id)
}
...
#[no_mangle]
pub extern "C" fn wire_chainremote_is_favorite(
    remote_id: *mut wire_uint_8_list,
) -> support::WireSyncReturn {
    wire_chainremote_is_favorite_impl(remote_id)
}

#[no_mangle]
pub extern "C" fn wire_chainremote_get_favorite_ids() -> support::WireSyncReturn {
    wire_chainremote_get_favorite_ids_impl()
}
